...
function initializeForm() {
	...
	if('${memVO.getCredit_card()}'){
		credit_card.card = '${memVO.getCredit_card()}';
		credit_card.card_expires = '${memVO.getCredit_card_expires()}' ? '${memVO.getCredit_card_expires()}'.split('-')[0]+'-'+'${memVO.getCredit_card_expires()}'.split('-')[1] : '';
		credit_card.card_cvc = ('${memVO.getCredit_card_cvc()}' !== '0' && '${memVO.getCredit_card_cvc()}') ? '${memVO.getCredit_card_cvc()}' : '';
		$('.memberForm [name="credit_card"]').val(credit_card.card);
		$('.memberForm [name="credit_card_expires"]').val(credit_card.card_expires);
		$('.memberForm [name="credit_card_cvc"]').val(credit_card.card_cvc);
	}
	// 地址
